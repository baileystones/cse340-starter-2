...
-- 5. Use an inner join to select the make & model fields from the inventory table & the classification name field from the classification table for inventory items in the 'Sport' category
SELECT
    i.inv_make,
    i.inv_model,
