...
-- TASK ONE: 4. Modify the 'GM Hummer' record to read 'a huge interior' instead of 'small interiors'
...
-- TASK ONE: 6. Update all records in the inventory table to add '/vehicles' to the middle of the file path in the inv_image and inv_thumbnail columns
UPDATE public.inventory
SET
